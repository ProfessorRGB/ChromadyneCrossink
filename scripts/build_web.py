"""Build the Chromadyne DRU web portal: compose pages from shared templates/assets,
...
PAGES = {
    "home":     ("HomePageHtml",     "Chromadyne DRU",                   "home",     ""),
    "files":    ("FilesPageHtml",    "Files - Chromadyne DRU",           "files",    '  <script src="/js/jszip.min.js"></script>'),
    "settings": ("SettingsPageHtml", "Settings - Chromadyne DRU", "settings", ""),
    "fonts":    ("FontsPageHtml",    "Fonts - Chromadyne DRU",           "fonts",    ""),
}
