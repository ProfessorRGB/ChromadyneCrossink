...
def parse_args():
    parser = argparse.ArgumentParser(description='Generate Chromadyne DRU release catalog JSON.')
    parser.add_argument(
        '--firmware',
        required=True,
        action='append',
...
def main():
    ...
    notes = args.notes or f'Chromadyne DRU {version} {args.channel} firmware'
