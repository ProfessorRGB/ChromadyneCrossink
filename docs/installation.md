...
1. Download the `firmware-*.bin` file for the build variant of your choosing from the [releases page](https://github.com/ProfessorRGB/ChromadyneCrossink/releases).
...
Download the `firmware-*.bin` file from the [releases page](https://github.com/ProfessorRGB/ChromadyneCrossink/releases), then connect your device with USB-C.
